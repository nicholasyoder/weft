...
// Shadow map (Phase 5) — shares this bind group rather than adding a 5th,
// which would exceed wgpu's confirmed default `max_bind_groups` limit
// (already at 4 for this pipeline).
@group(3) @binding(1)
